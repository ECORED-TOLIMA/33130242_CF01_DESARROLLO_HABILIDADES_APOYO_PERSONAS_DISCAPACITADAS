...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta--BG02.p-4
      ...
      p.mb-4 A continuación, se presenta un ejemplo: 
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-10
    ...
    .tarjeta--BG03.pe-5.ps-4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-9
          p En el anterior fragmento, Amnistía Internacional, muestra cómo los países actualmente no tienen en todos los casos, un trato diferencial con las personas con discapacidad que han cometido delitos y siguen prescindiendo de ellas como se realizaba históricamente en Grecia y Roma.
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p.mb-0 Sin embargo, es importante aclarar que no todas las personas con discapacidad mejoran su condición con tratamientos o capacitaciones. Por ejemplo:
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-9
        p Esto no significa que no pueda aprender, pero es una decisión personal —y familiar— optar por la lengua de señas o la oralidad. Dejar de lado la conexión entre ideas y lenguaje evita caer en afirmaciones como que “las manos y la mente se mueven al mismo ritmo”, como sugería Aristóteles.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .bloque-texto-c.color-primario-beige.p-4
          .row.justify-content-center.align-items-center
            .col-lg-11
              p.mb-0 …se entiende por persona inválida toda persona cuyas posibilidades de obtener y conservar un empleo adecuado y de progresar en el mismo queden sustancialmente reducidas a causa de una deficiencia de carácter físico o mental debidamente reconocida. (Definición de la persona con discapacidad, OIT, 1983).
            .col-lg-1(data-aos="zoom-in")
              figure
    ...
    p Según Stellman (1998), en el contexto de la salud: 
    ...
    p.mb-4 En la actualidad, el enfoque de derechos se ha convertido en un eje central cuando se habla de atención a personas con discapacidad. Este modelo, también conocido como modelo social, plantea una transformación profunda en la forma de entender la discapacidad, alejándose de visiones centradas en la deficiencia o la enfermedad.
    ...
    .bloque-texto-c.color-primario-medio
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-7
          ...
          p Así mismo, la Declaración Universal de los Derechos Humanos de 1948 establece en su Artículo 1 que “Todos los seres humanos nacen libres e iguales en dignidad y derechos, y dotados como están de razón y conciencia”. Sin embargo, esta formulación deja por fuera a un número significativo de personas que no cumplen con estas características, como aquellas con parálisis cerebral severa, que no pueden elegir libremente, adquirir propiedades o expresar su opinión. En consecuencia, se podría interpretar que estas personas no realizan las acciones que el artículo protege y defiende, lo que llevaría a la preocupante conclusión de que serían consideradas como personas sin derechos.
    ...
    .tarjeta--BG02.p-4
      p.mb-4 Los documentos vinculantes son:
    ...
    p Además de los anteriores documentos, también se encuentran las normas uniformes para la igualdad de oportunidades para las personas con discapacidad y la relatoría especial sobre discapacidad. 
    ...
    p.mb-4 Basado en lo anterior, a continuación, se detalla una línea del tiempo, con respecto a los documentos vinculantes y no vinculantes: 
    ...
    p.mb-4 Sin embargo, dicho informe advierte una debilidad persistente: la excesiva confianza depositada en la legislación, sin considerar las condiciones reales y concretas de la sociedad colombiana. En relación con el derecho al trabajo, la observación señala:
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p Al comité le preocupa que los esfuerzos para promover la inclusión laboral de personas con discapacidad son escasos y de bajo impacto, aunado a las evidentes desigualdades interseccionales. También le preocupa la persistente discriminación basada en la discapacidad y la ausencia de una regulación de los ajustes razonables.
        p El Comité le recomienda al Estado parte que:
        .bloque-texto-c.color-primario-medio.p-4
          .row
            .col-lg-9
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p Lo anterior muestra que, a más de diez años de la Convención y a quince de su ratificación por parte del Estado colombiano, las acciones afirmativas como la ley 1618 de 2013, revisada en Sentencia de Constitucionalidad C-765/12 y el CONPES 166 de 2013 (Política Pública Nacional de discapacidad e inclusión social), se quedaron en el papel y no pasaron a verse reflejadas en las vidas de las personas con discapacidad. En este mismo sentido, Colombia no ha hecho lo necesario en el tema de accesibilidad, señala también el Informe de la observación realizada por el comité:
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5 
        .tarjeta--boton.color-primario.p-4
          ...
          p.text-small  Los Estados Parte reafirman que las personas con discapacidad tienen derecho en todas partes al reconocimiento de su personalidad jurídica.
      ...
      .col-lg-5 
        .tarjeta--boton.color-primario.p-4
          ...
          p.text-small  Los Estados Parte reconocerán que las personas con discapacidad tienen capacidad jurídica en igualdad de condiciones con las demás en todos los aspectos de la vida. (ONU, 2006).
    p Este cuarto pilar representa una ruptura definitiva con la tradición occidental en materia de derechos humanos, la cual históricamente ha excluido a las personas con discapacidad bajo argumentos relacionados con la razón. Su incorporación obliga a reformar las legislaciones internas, promoviendo el uso de un lenguaje inclusivo y reconociendo la voz y agencia de las personas con discapacidad.
    p.mb-4 Este pilar plantea una pregunta fundamental: 

    p La Convención sobre los Derechos de las Personas con Discapacidad, como desarrollo normativo en el ámbito de los derechos humanos, propone una visión integral del ser humano. No se trata únicamente de reconocer a las personas con discapacidad como receptoras de derechos, sino también como creadoras de oportunidades y agentes activos en la sociedad.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .bloque-texto-c.color-primario-oscuro.p-4
          p Apoyar es distinto a decidir por otro. Apoyar es creer que el otro es un ser humano integral y dentro de esa unidad está ser libre, como lo muestran las distintas declaraciones de derechos humanos y todas las convenciones.
    p.mb-4 Hasta aquí se han tratado cuatro pilares de la convención, que son fundamentales para el reconocimiento de las personas con discapacidad, así como de sus derechos. Y como resumen, a continuación, basado en las Naciones Unidas, se detalla cada uno:  
