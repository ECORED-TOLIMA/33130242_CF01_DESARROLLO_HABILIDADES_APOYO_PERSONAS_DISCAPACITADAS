...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9
        p.mb-0 Este documento debe contener detalladamente cómo la persona con discapacidad responde a cada una de las actividades de la vida diaria, como en la red de apoyos, que puede ser un familiar, un amigo o una persona de confianza. La persona encargada de realizar los apoyos está descrita en el Decreto 487 de 2022, cuyo propósito es “reglamentar la prestación del servicio de valoración de apoyos que realicen las entidades públicas y privadas en los términos de la Ley 1996 de 2019”, donde se habla de las personas funcionarias que deben y pueden realizar dicha valoración. 
    p.mb-4 Respecto a ello, se abre la siguiente pregunta: 
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .tarjeta-BG07.tarjeta.p-4
          ...
          .row.justify-content-center
            .col-lg-6
              h4.text-center ¿Cuál es la habilidad mayor que requiere una persona encargada de realizar apoyos?
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p Es tener conocimiento de la discapacidad, de cuáles son sus tipos, sus normativas, pero más allá de eso, el perfil debe de estar definido por ser una persona que reconoce a las demás, en su condición de seres humanos íntegros (as, es) y que, al igual que ella, sienten, piensan, deciden, sueñan y pueden ser no solo aportar a la sociedad, sino también necesarios.
    ...
    .row.justify-content-center.mb-4
      ...
      .col-lg-11
        p.mb-0(data-aos="fade-left") En consecuencia, aún existen voces en Colombia que proponen regresar al modelo de interdicción, desconociendo y deslegitimando los avances de la Ley 1996 de 2019. Bajo esta perspectiva, la persona con discapacidad es vista únicamente como un cuerpo marcado por una deficiencia o minusvalía, anulando su autonomía y reduciendo su identidad a un diagnóstico médico. Este retroceso no solo contradice el espíritu de la convención, sino que impide la construcción de una sociedad verdaderamente inclusiva y respetuosa de la diversidad humana.
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p Desde este enfoque de derechos humanos, que también incorpora modelos como el de la diversidad funcional y el de vida independiente en comunidad, se ha venido consolidando en Colombia un marco legal y jurisprudencial orientado a la protección de los derechos de las personas con discapacidad: 
      ...
      .row.justify-content-center.align-items-center
        .col-lg-10.order-lg-1.order-2.mb-lg-0.mb-4
          ul.lista-ul--color
              ...
              li 
                i.fas.fa-user
                | Identificar a las personas que hacen parte de la red de apoyo de la persona con discapacidad, tanto en su familia como en los diferentes escenarios en los que se relaciona en comunidad.
              li 
                i.fas.fa-user
                | Entender los vínculos que unen a las personas, de la red de apoyo con la persona con discapacidad. 
              li 
                i.fas.fa-user
                | Distinguir las capacidades y habilidades desarrolladas para la toma de decisiones y las necesidades que tenga la persona al respecto.
              li 
                i.fas.fa-user
            ...
            .row.justify-content-center.align-items-center
              .col-lg-9.order-lg-1.order-2.mb-lg-0.mb-4
                ul.lista-ul--color
                  li 
                    i.fas.fa-user
                    | Motivaciones y proyecto de vida de la persona.
                  li 
                    i.fas.fa-user
                  ...
                  li 
                    i.fas.fa-user
                    | Salud (física, mental, psicológica, sexual y reproductiva).
                  li 
                    i.fas.fa-user
                    | Trabajo y generación de ingresos.
                  li 
                    i.fas.fa-user
                    | Acceso a la justicia, participación política y ciudadana.
                  li 
                    i.fas.fa-user
                    | Nivel educativo.
                  li 
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        p Además de los aspectos interdisciplinarios, el enfoque de género resulta fundamental para brindar una atención y acompañamiento con perspectiva diferencial, coherente con las realidades de las personas con discapacidad y sus familias. Las particularidades relacionadas con el sexo y el género influyen de manera significativa en la asignación social de roles, el acceso a oportunidades, las necesidades fisiológicas específicas y, en general, en el reconocimiento de las barreras que afectan el ejercicio de capacidades y la autonomía personal.
        p.mb-0 De acuerdo con la ONU Mujeres, el Fondo de Población de las Naciones Unidas (UNFPA) y el Fondo de las Naciones Unidas para la Infancia (UNICEF):
      ...
      .col-lg-10
        .bloque-texto-c.color-primario.p-4
          .bloque-texto-b__texto
            i.fas.fa-quote-left
            p.text-bold.mb-0.ms-2 Condiciones como el género pueden agudizar aún más las condiciones y entornos no propicios al desarrollo de los derechos.
            br
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        p.mb-0 En el marco del tema de la interdisciplinariedad, se comparte el siguiente pódcast, el cual aborda perspectivas diversas y complementarias con respecto al tema:
